...
-- Tab Functions
local function CreateElement(parent, elementType, properties)
...
-- Paragraph
function CurrentWindow:CreateParagraph(Settings)
	if not CurrentTab then return end
	
	local Container = CreateElement(CurrentTab.Content, "Frame", {
	...
	if Settings.Title then
		local Title = CreateElement(Container, "TextLabel", {
	...
	local Content = CreateElement(Container, "TextLabel", {
		Size = UDim2.new(1, 0, 0, 0),
		Position = Settings.Title and UDim2.new(0, 0, 0, 25) or UDim2.new(0, 0, 0, 0),
		BackgroundTransparency = 1,
	...
	local Layout = CreateElement(Container, "UIListLayout", {
...
-- Button
function CurrentWindow:CreateButton(Settings)
	if not CurrentTab then return end
	
	local Button = CreateElement(CurrentTab.Content, "TextButton", {
	...
	local Corner = CreateElement(Button, "UICorner", {
...
-- Toggle
function CurrentWindow:CreateToggle(Settings)
	if not CurrentTab then return end
	...
	local ContainerCorner = CreateElement(Container, "UICorner", {
		CornerRadius = UDim.new(0, 6)
	})

	local Label = CreateElement(Container, "TextLabel", {
	...
	local ToggleButton = CreateElement(Container, "TextButton", {
		Size = UDim2.new(0, 40, 0, 20),
		Position = UDim2.new(1, -50, 0.5, -10),
		BackgroundColor3 = Settings.CurrentValue and Color3.fromRGB(60, 120, 180) or Color3.fromRGB(80, 80, 80),
		BorderSizePixel = 0,
		Text = ""
	})

	local ToggleCorner = CreateElement(ToggleButton, "UICorner", {
		CornerRadius = UDim.new(0.5, 0)
	})

	local ToggleCircle = CreateElement(ToggleButton, "Frame", {
	...
	local CircleCorner = CreateElement(ToggleCircle, "UICorner", {
		CornerRadius = UDim.new(0.5, 0)
	})
...
-- Slider
function CurrentWindow:CreateSlider(Settings)
	if not CurrentTab then return end
	...
	local ValueLabel = CreateElement(Container, "TextLabel", {
		Size = UDim2.new(0, 50, 0, 20),
		Position = UDim2.new(1, -60, 0, 5),
		BackgroundTransparency = 1,
		Text = tostring(Settings.CurrentValue or Settings.Range[1]),
		TextColor3 = Color3.fromRGB(200, 200, 200),
		Font = Enum.Font.SourceSans,
		TextSize = 10,
	...
	local SliderFrame = CreateElement(Container, "Frame", {
	...
	local SliderCorner = CreateElement(SliderFrame, "UICorner", {
		CornerRadius = UDim.new(0.5, 0)
	})

	local SliderButton = CreateElement(SliderFrame, "TextButton", {
	...
	local ButtonCorner = CreateElement(SliderButton, "UICorner", {
		CornerRadius = UDim.new(0.5, 0)
	})
...
-- Input
function CurrentWindow:CreateInput(Settings)
	if not CurrentTab then return end
	...
	local InputBox = CreateElement(Container, "TextBox", {
	...
	local InputCorner = CreateElement(InputBox, "UICorner", {
...
-- Dropdown
function CurrentWindow:CreateDropdown(Settings)
	if not CurrentTab then return end
	...
	local DropdownButton = CreateElement(Container, "TextButton", {
		Size = UDim2.new(0.5, -20, 0, 25),
		Position = UDim2.new(0.5, 10, 0, 5),
		BackgroundColor3 = Color3.fromRGB(30, 30, 40),
		BorderSizePixel = 0,
		Text = Settings.CurrentOption or "Select...",
		TextColor3 = Color3.fromRGB(255, 255, 255),
		Font = Enum.Font.SourceSans,
		TextSize = 10
	})

	local DropdownCorner = CreateElement(DropdownButton, "UICorner", {
		CornerRadius = UDim.new(0, 4)
	})
